...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Row(children: [IconButton(onPressed: Get.back, icon: const Icon(Icons.arrow_back)), const SizedBox(width: 8), const Expanded(child: Text('2-night stay', maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 30, fontWeight: FontWeight.w800))), const SizedBox(width: 8), Flexible(child: Text('Cancel Date', maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.end, style: TextStyle(color: Colors.orange, fontWeight: FontWeight.w700)))]),
