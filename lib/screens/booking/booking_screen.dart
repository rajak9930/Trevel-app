...
class BookingScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => AppBackground(child: Scaffold(backgroundColor: Colors.transparent, body: Stack(children: [SafeArea(child: ListView(padding: const EdgeInsets.fromLTRB(28, 24, 28, 100), children: [
  ...
  ])), const Positioned(left: 0, right: 0, bottom: 18, child: BottomNav())])));
}
